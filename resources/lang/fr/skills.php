...
de son adversaire même en cas de défaite (le personnage l’annonce durant l’empoignade juste après
son score de bagarre).'
        ],
...
Un personnage équipé d’un bouclier ou d’une arme autre qu’une arme courte la perd
instantanément.'
        ],
...
supplémentaire qui participe à la représentation, 1 main d’oeuvre supplémentaire est générée pour
l’auditoire au terme de celle-ci.'
        ],
...
servi par un cuisinier ne peut pas être empoisonné. Le repas doit être copieux, et consommé chez le
cuisinier.'
        ],
...
rebouteux oeuvre sur un patient dans le coma, les 5 sabliers qui rapprochent le patient de la mort
sont suspendus.'
        ],
...
informer la caravane pour laquelle ils travaillent de l’emplacement des objectifs à prendre, des forces
en présence, etc.'
        ],
...
frappe. Cette capacité ne s’utilise qu’avec une arme à deux mains (entre 110cm et 150 cm, pas une
arme d’hast).'
        ],
...
d’une frappe. Cette capacité ne s’utilise qu’avec une arme à deux mains de 110 cm à 150 cm. (pas
une arme d’hast).'
        ],
...
d’armure manquant. En dehors du temps passé, aucune ressource n’est nécessaire pour réparer une
armure.'
        ],
